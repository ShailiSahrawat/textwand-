...
export default function TextForm(props) {
    ...
    return (
        <>
        <div className="container " style={{color: 'white', opacity:1, fontWeight:"bold"}}> 
            <h1 className='mb-4'>{props.heading}</h1>
            <div className="mb-3"> 
            <textarea className="form-control" value={text} onChange={handleOnChange} style={{background:"#4a0d07", border: '1px solid white' , color:'white', fontSize:'16px'}} id="myBox" rows="8"></textarea>
            </div>
